 ...
 *          0 - ни X ни Y не являются значимыми цифрами (ни бык ни корова)
 *          1 - если Х = 1, то Y = 0 и наоборот.
 *          2 - X и Y - вляются значимыми цифрами.
 ...
 *              Например: Х:[56] = 1, Y:[78] = 1, Z:[90] = 1, перемешиваем Х и Y, и получаем X1 Y1:
 *          X1:[85], Y1:[67], Z1:[90]
 ...
 *
 * Подсказка: все позиции в stage2 ведутся в [byte].
 *
