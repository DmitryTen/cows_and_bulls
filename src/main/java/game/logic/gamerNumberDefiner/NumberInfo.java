 ...
 * Класс хранит информацию о каждом числе: число(num), количество коров, количество быков, и индексы из которых состояло
 * число.
 *
 * Чтобы превратить индексы в число в классе NumberDefiner есть случайная последовательность цифр от 0 до 9, rndSecuence
 */
