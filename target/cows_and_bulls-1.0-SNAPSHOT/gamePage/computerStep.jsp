...
<html>
    ...
    <body>
		...
		<c:forEach var="numberViewPlayer" items="${pageView.playerList}">
			<p>Ход№: <c:out value="${numberViewPlayer.step}"/>, Игрок: <c:out value="${numberViewPlayer.playerName}"/>,Число:
				<c:out value="${numberViewPlayer.number}"/>, Коров: <c:out value="${numberViewPlayer.cows}"/>, Быков: <c:out value="${numberViewPlayer.bulls}"/> </p>
		</c:forEach>

		<c:forEach var="numberViewComputer" items="${pageView.computerList}">
			<p>Ход№: <c:out value="${numberViewComputer.step}"/>, Игрок: <c:out value="${numberViewComputer.playerName}"/> , Число:
				<c:out value="${numberViewComputer.number}"/>, Коров: <c:out value="${numberViewComputer.cows}"/>, Быков: <c:out value="${numberViewComputer.bulls}"/> </p>
		</c:forEach>
