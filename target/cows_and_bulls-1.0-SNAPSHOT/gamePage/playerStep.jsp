...
<html>
    ...
    <body>
		...
		<c:forEach var="numberViewPlayer" items="${pageView.playerList}">
			<p>Ход№: <c:out value="${numberViewPlayer.step}"/>, Игрок: <c:out value="${numberViewPlayer.gamerName}"/>,Число:
		...
		<c:forEach var="numberViewComputer" items="${pageView.computerList}">
			<p>Ход№: <c:out value="${numberViewComputer.step}"/>, Игрок: <c:out value="${numberViewComputer.gamerName}"/> , Число:
